...
function Home({children} :any): JSX.Element {
    ...
    const [toBeDisplayed, setTobeDisplayed] = useState<arrItem[]>(data)
    ...
    const settingCurrent = (data:arrItem[]) => {
        console.log('inside setting current',data, toBeDisplayed,  currentCountries)
    ...
    console.log('toBeDisplayed', toBeDisplayed, 'general', currentCountries)
    const selectRegion = () =>{
        let arr:arrItem[] = []
