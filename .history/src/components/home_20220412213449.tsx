        ...
        <div className='body'>
            ...
            <div className='secondhalf'>
                <form onSubmit={(e) => e.preventDefault()}>
                    <div>
                        <img alt='search icon'/>
                        <input value={inputValue} type='text' onChange={(evt:React.FormEvent<HTMLInputElement>) => setInputValue((evt.target as HTMLInputElement).value)} placeholder='Search for a country...'/>
                    </div>
                    <select name='region'>
