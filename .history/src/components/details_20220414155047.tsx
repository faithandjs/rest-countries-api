...
function Details() {
    const { data, details, currentIcons } = useContext(Wrapper) as contextType
    return (
        <div>
            ...
            <div>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li><span>languages</span> {details.languages}</li>
                    </ul>
                    <div><span>border countries</span>{details.borderCountries}</div>
                </div>
            </div>
        </div>
    );
